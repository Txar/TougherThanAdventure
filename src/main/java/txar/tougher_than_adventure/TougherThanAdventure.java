...
import txar.tougher_than_adventure.blocks.BlockStrippedLog;
import txar.tougher_than_adventure.items.*;
import txar.tougher_than_adventure.mixins.TougherCraftingManagerAccessor;
...
public class TougherThanAdventure implements ModInitializer {
    public static final String MOD_ID = "tougher_than_adventure";
